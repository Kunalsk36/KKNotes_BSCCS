...
class FySem1Sub1RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub1_ref_book)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1Q5KmhlDS_ohwk_6pnYoGWWLOmGcYA_P9/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1Q5KmhlDS_ohwk_6pnYoGWWLOmGcYA_P9"
        )
        intent.putExtra(
            "pdf_name",
            "Computer_Organization_and_Embedded_System"
        )
