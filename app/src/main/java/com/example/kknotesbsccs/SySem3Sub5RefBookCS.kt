...
class SySem3Sub5RefBookCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub5_ref_book_cs)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/11K1Lx-fOVi0aAxN4CJuUZj6_8SkonXJs/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=11K1Lx-fOVi0aAxN4CJuUZj6_8SkonXJs"
        )
        intent.putExtra(
            "pdf_name",
            "Java_Ref_Book"
