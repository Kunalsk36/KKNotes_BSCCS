...
class SySem3Sub3QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub3_ques_paper_cs)
        ...
        CommonOnClicks(navSem1Sub1, this, SySem3Sub3CS::class.java)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1WZyyd659DqYfsyvliTbpedVsflqHGmMa/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1WZyyd659DqYfsyvliTbpedVsflqHGmMa"
        )
        intent.putExtra(
            "pdf_name",
            "DS_2022_QP"
