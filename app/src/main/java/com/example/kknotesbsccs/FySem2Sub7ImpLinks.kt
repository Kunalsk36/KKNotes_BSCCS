...
class FySem2Sub7ImpLinks : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub7_imp_links)
    ...
    fun impLink1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://www.slideshare.net/ShilpaKini4/ecommerce-digital-marketing-unit-1"
        )
    ...
    fun impLink2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://indiafreenotes.com/umbms-e-commerce-digital-marketing/"
        )
        startActivity(intent)
    }
}