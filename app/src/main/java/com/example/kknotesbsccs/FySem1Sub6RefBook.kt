...
class FySem1Sub6RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub6_ref_book)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1XMmfn3nbHvyV9Pgyr6SLCBotgeeMjAJH/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1XMmfn3nbHvyV9Pgyr6SLCBotgeeMjAJH"
        )
        intent.putExtra(
            "pdf_name",
            "FYBScCS_Descriptive_Statistics"
        )
