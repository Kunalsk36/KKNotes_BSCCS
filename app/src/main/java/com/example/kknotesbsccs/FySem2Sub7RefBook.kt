...
class FySem2Sub7RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub7_ref_book)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1wHZJ_d69G1vjuvIwoUCGJDP6bR_bhpYC/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1wHZJ_d69G1vjuvIwoUCGJDP6bR_bhpYC"
        )
        intent.putExtra(
            "pdf_name",
            "E_Commerce_Author_MS_K_Bhavithravani"
        )
