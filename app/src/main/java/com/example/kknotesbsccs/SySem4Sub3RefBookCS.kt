...
class SySem4Sub3RefBookCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub3_ref_book_cs)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1JvRb_fC_rpxzVzFF_isBfrazp_V4Zi64/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1JvRb_fC_rpxzVzFF_isBfrazp_V4Zi64"
        )
        intent.putExtra(
            "pdf_name",
            "SE_Ref_Book_KK"
