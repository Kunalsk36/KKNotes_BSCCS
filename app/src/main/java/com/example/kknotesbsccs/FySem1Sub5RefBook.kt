...
class FySem1Sub5RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub5_ref_book)
        ...
        CommonOnClicks(navSem1Sub1, this, FySem1Sub5::class.java)
