...
class SySem4Sub6QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub6_ques_paper_cs)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1Z0Xc1jeCJ555Ga-xOZVuyKF-rhejjHp7/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1Z0Xc1jeCJ555Ga-xOZVuyKF-rhejjHp7"
        )
        intent.putExtra(
            "pdf_name",
            "Advance_App_Dev_2023_QP_KKNotes"
        )
