...
class FySem2Sub5ImpLinks : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub5_imp_links)
    ...
    fun impLink2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://www.sanfoundry.com/mathematics-questions-answers-calculus-application-increasing-decreasing-functions/"
        )
        startActivity(intent)
    }
}