...
class SySem3Sub4QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub4_ques_paper_cs)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/14Rf51MTtmXurF7zx7kmU0QFL6RxDMfE6/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=14Rf51MTtmXurF7zx7kmU0QFL6RxDMfE6"
        )
        intent.putExtra(
            "pdf_name",
            "ADC_2022_QP"
