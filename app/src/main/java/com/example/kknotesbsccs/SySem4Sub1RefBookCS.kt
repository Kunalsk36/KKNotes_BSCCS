...
class SySem4Sub1RefBookCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub1_ref_book_cs)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1CA_NtoRW9Gp57UzW2sEYhkZHid2M-b2S/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1CA_NtoRW9Gp57UzW2sEYhkZHid2M-b2S"
        )
        intent.putExtra(
            "pdf_name",
            "Theory_of_Automata_Ref_Book_KK"
        )
