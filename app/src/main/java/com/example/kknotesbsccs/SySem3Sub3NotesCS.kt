...
class SySem3Sub3NotesCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub3_notes_cs)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1hRzhViQG7mKQq09Cj4cQ5Cz06HKJ44yZ/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1hRzhViQG7mKQq09Cj4cQ5Cz06HKJ44yZ"
        )
        intent.putExtra(
            "pdf_name",
            "DS_Notes"
