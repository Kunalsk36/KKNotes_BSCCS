...
class FySem1Sub1QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub1_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1jdegstbossrvON9OVWNZ0zw98l7tIKBy/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1jdegstbossrvON9OVWNZ0zw98l7tIKBy"
        )
        intent.putExtra(
            "pdf_name",
            "DSA_2022_QP"
