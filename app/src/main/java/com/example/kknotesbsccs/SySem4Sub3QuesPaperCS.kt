...
class SySem4Sub3QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub3_ques_paper_cs)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/12_JCA1JbrwviSC4q3otVTqo0iLttVNBs/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=12_JCA1JbrwviSC4q3otVTqo0iLttVNBs"
        )
        intent.putExtra(
            "pdf_name",
            "SE_2023_QP_KKNotes"
