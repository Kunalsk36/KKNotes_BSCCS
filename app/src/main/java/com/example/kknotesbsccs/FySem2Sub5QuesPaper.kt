...
class FySem2Sub5QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub5_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1w4QmNDqLmnDl788582hXbTLJbbEia4gZ/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1w4QmNDqLmnDl788582hXbTLJbbEia4gZ"
        )
        intent.putExtra(
            "pdf_name",
            "Calculus_2022_Question_Paper"
        )
