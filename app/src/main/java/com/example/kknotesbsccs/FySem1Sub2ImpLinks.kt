...
class FySem1Sub2ImpLinks : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub2_imp_links)
        ...
        val navSem1Sub2 = findViewById<TextView>(R.id.navFYSem1Sub1)
        CommonOnClicks(navSem1Sub2, this, FySem1Sub2::class.java)
