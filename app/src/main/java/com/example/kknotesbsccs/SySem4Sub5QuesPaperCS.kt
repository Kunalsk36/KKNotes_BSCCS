...
class SySem4Sub5QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub5_ques_paper_cs)
        ...
        CommonOnClicks(navSem1Sub1, this, SySem4Sub5CS::class.java)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1kDLCHKVJ_fWN6HO67id-qj5kkmQVu682/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1kDLCHKVJ_fWN6HO67id-qj5kkmQVu682"
        )
        intent.putExtra(
            "pdf_name",
            "Android_App_Dev_2023_QP_KKNotes"
        )
