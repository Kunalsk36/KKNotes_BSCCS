...
class SySem4Sub7QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub7_ques_paper_cs)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1KnX-0-kjCzdCRDZ2rz-TvFR37KBG7ARj/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1KnX-0-kjCzdCRDZ2rz-TvFR37KBG7ARj"
        )
        intent.putExtra(
            "pdf_name",
            "M_and_E_2023_QP_KKNotes"
        )
