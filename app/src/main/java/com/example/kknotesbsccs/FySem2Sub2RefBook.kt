...
class FySem2Sub2RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub2_ref_book)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1liMxnCH60RxZn94_VG_SWGbhwdbL92To/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1liMxnCH60RxZn94_VG_SWGbhwdbL92To"
        )
        intent.putExtra(
            "pdf_name",
            "Programming_with_python_II"
        )
    ...
    fun refbook2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1Bt-I-ACBCUz3MMnlseIm_BmE65SeUoaW/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1Bt-I-ACBCUz3MMnlseIm_BmE65SeUoaW"
        )
        intent.putExtra(
            "pdf_name",
            "Practical_programming_third_edition"
        )
        startActivity(intent)
    }
}