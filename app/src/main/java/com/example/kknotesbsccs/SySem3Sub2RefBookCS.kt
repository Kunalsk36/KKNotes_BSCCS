...
class SySem3Sub2RefBookCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub2_ref_book_cs)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1_CMBWQmMbublXWS7BpvJ7wEKJbntxjdP/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1_CMBWQmMbublXWS7BpvJ7wEKJbntxjdP"
        )
        intent.putExtra(
            "pdf_name",
            "Linear_algebra_using_python"
        )
