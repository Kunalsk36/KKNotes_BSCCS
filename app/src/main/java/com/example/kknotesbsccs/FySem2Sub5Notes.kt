...
class FySem2Sub5Notes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub5_notes)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1_LRnlSVqtdSdkkOsZCB2F1GwVOycxqEC/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1_LRnlSVqtdSdkkOsZCB2F1GwVOycxqEC"
        )
        intent.putExtra(
            "pdf_name",
            "Calculus_Question_Bank"
        )
