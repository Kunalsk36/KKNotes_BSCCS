...
class FySem2Sub5RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub5_ref_book)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1HszGKyUf1wj2jIzf5v-Rdq_d7RyHwnQg/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1HszGKyUf1wj2jIzf5v-Rdq_d7RyHwnQg"
        )
        intent.putExtra(
            "pdf_name",
            "Calculus_early_transcendentals_10th_ed"
        )
