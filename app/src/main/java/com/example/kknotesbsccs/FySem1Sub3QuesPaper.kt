...
class FySem1Sub3QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub3_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1yXKMk-noRGiB62uhIpIk-FMn6IXeD9Z-/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1yXKMk-noRGiB62uhIpIk-FMn6IXeD9Z-"
        )
        intent.putExtra(
            "pdf_name",
            "Linux_2022_QP"
