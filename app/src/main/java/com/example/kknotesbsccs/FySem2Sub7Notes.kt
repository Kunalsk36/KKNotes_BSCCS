...
class FySem2Sub7Notes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub7_notes)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1NuKZS_Q2qxuAsvsH76p8-GQNLShgUhn6/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1NuKZS_Q2qxuAsvsH76p8-GQNLShgUhn6"
        )
        intent.putExtra(
            "pdf_name",
            "E_commerce_Question_Bank"
        )
