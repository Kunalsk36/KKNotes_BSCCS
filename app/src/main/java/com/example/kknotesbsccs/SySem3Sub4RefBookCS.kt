...
class SySem3Sub4RefBookCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub4_ref_book_cs)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1fpPlI3XnlNNsnHkxdS91CJKD5n9nSroD/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1fpPlI3XnlNNsnHkxdS91CJKD5n9nSroD"
        )
        intent.putExtra(
            "pdf_name",
            "PL_SQL_TUTORIAL"
