...
class FySem1Sub4ImpLinks : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub4_imp_links)
    ...
    fun impLink3Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://engineeringinterviewquestions.com/mcqs-on-open-source-software-answers/"
        )
        startActivity(intent)
    }
}