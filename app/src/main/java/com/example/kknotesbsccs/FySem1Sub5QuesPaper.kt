...
class FySem1Sub5QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub5_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1IxO8q00X7KtSjbIM8AeOFdM9BzS417OR/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1IxO8q00X7KtSjbIM8AeOFdM9BzS417OR"
        )
        intent.putExtra(
            "pdf_name",
            "DM_2022_QP"
