...
class FySem2Sub7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub7)
    ...
    fun refBookClick(view: View) {
        intent = Intent(this, FySem2Sub7RefBook::class.java)
        startActivity(intent)
    }

    fun notesClick(view: View) {
        intent = Intent(this, FySem2Sub7Notes::class.java)
        startActivity(intent)
    }

    fun questionpaperClick(view: View) {
        intent = Intent(this, FySem2Sub7QuesPaper::class.java)
        startActivity(intent)
    }
    ...
    fun implinkClick(view: View) {
        intent = Intent(this, FySem2Sub7ImpLinks::class.java)
        startActivity(intent)
    }
}