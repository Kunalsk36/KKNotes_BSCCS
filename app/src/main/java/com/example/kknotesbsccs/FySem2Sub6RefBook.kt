...
class FySem2Sub6RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub6_ref_book)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/17TxtnwJ-3X19Rm-qrBL3u_NENkyivKL1/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=17TxtnwJ-3X19Rm-qrBL3u_NENkyivKL1"
        )
        intent.putExtra(
            "pdf_name",
            "FUNDAMENTAL_OF_MATHEMATICAL_STATISTICS"
        )
