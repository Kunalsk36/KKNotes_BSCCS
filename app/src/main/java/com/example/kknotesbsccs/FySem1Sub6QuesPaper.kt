...
class FySem1Sub6QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub6_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/11nmk7pZNEt8BBxlejC4rZbDRqxulCmxr/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=11nmk7pZNEt8BBxlejC4rZbDRqxulCmxr"
        )
        intent.putExtra(
            "pdf_name",
            "DS_2022_QP"
