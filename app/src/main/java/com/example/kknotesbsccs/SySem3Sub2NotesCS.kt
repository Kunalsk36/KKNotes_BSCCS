...
class SySem3Sub2NotesCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub2_notes_cs)
        ...
        CommonOnClicks(navSem1Sub1, this, SySem3Sub2CS::class.java)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1QMskiKMI9RuJsUcQ11G9ZLsn6obetbQK/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1QMskiKMI9RuJsUcQ11G9ZLsn6obetbQK"
        )
        intent.putExtra(
            "pdf_name",
            "LA_Notes"
    ...
    fun notes2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1ZvjH8qiOs5sfkuZvoTEAGYcALEv_8HGZ/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1ZvjH8qiOs5sfkuZvoTEAGYcALEv_8HGZ"
        )
        intent.putExtra(
            "pdf_name",
            "Question_Bank_LA"
