...
class FySem2Sub6ImpLinks : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub6_imp_links)
    ...
    fun impLink1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://www.sanfoundry.com/1000-probability-statistics-questions-answers/"
        )
