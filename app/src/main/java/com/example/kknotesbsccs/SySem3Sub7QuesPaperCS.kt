...
class SySem3Sub7QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub7_ques_paper)
        ...
        CommonOnClicks(navSem1Sub1, this, SySem3Sub7CS::class.java)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1XDJHdeFNr3WcyHpDM1ZttxiJgsh7c-Vw/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1XDJHdeFNr3WcyHpDM1ZttxiJgsh7c-Vw"
        )
        intent.putExtra(
            "pdf_name",
            "Creative_Content_Writing_2022_QP_KK"
        )
