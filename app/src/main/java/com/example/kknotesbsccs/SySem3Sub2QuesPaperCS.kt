...
class SySem3Sub2QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub2_ques_paper_cs)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1zb4SyCU9vdsNGCOwGmEhExQAdTrOgWgG/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1zb4SyCU9vdsNGCOwGmEhExQAdTrOgWgG"
        )
        intent.putExtra(
            "pdf_name",
            "LA_2022_QP"
