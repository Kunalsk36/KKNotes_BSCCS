...
class SySem3Sub5QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub5_ques_paper_cs)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1xJlL1PnSbHgY9R-wfiYKCD67BFkUnY9A/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1xJlL1PnSbHgY9R-wfiYKCD67BFkUnY9A"
        )
        intent.putExtra(
            "pdf_name",
            "Java_2022_QP_KK"
