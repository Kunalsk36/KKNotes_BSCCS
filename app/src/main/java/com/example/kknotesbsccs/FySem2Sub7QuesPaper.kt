...
class FySem2Sub7QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub7_ques_paper)
        ...
        CommonOnClicks(navSem1Sub1, this, FySem2Sub7::class.java)
    ...
    fun qp1Click(view: View) {
        Toast.makeText(this, "Please wait, loading...", Toast.LENGTH_LONG).show()
        val intent = Intent(applicationContext, PDFView::class.java)
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1lAC5Xs-wxywnr2CKBUV5kQglNS-lbk6C/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1lAC5Xs-wxywnr2CKBUV5kQglNS-lbk6C"
        )
        intent.putExtra(
            "pdf_name",
            "ECom_DM_2021_Question_Paper"
        )
        startActivity(intent)
    }

    fun qp2Click(view: View) {
        Toast.makeText(this, "Please wait, loading...", Toast.LENGTH_LONG).show()
        val intent = Intent(applicationContext, PDFView::class.java)
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1_SIiIZ0p8XcgvHvaVWH0Y90Fl0FZksZ4/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1_SIiIZ0p8XcgvHvaVWH0Y90Fl0FZksZ4"
        )
        intent.putExtra(
            "pdf_name",
            "ECom_DM_2022_Question_Paper"
        )
        startActivity(intent)
    }
}