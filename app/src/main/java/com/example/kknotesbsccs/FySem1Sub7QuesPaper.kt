...
class FySem1Sub7QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub7_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/11C8-ZCeCzyi-Ljq7UOwe6GItZ6Utyr-9/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=11C8-ZCeCzyi-Ljq7UOwe6GItZ6Utyr-9"
        )
        intent.putExtra(
            "pdf_name",
            "SS_2022_QP"
