...
class SySem4Sub3PracticalsCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub3_practicals_cs)
    ...
    fun prac1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1osBjRM0VPykoUPzaHwTDhRuMqehqm-Qq/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1osBjRM0VPykoUPzaHwTDhRuMqehqm-Qq"
        )
        intent.putExtra(
            "pdf_name",
            "SE_LMS_KKNotes"
    ...
    fun prac2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1C89zzYBQeXxbT9wMucWZ42b0UztDLvq2/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1C89zzYBQeXxbT9wMucWZ42b0UztDLvq2"
        )
        intent.putExtra(
            "pdf_name",
            "SE_SAMS_VS_KKNotes"
    ...
    fun prac3Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1xKp8F-0rzOySctG3dNRSsr8g_jXC-wg9/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1xKp8F-0rzOySctG3dNRSsr8g_jXC-wg9"
        )
        intent.putExtra(
            "pdf_name",
            "SE_DABS_RK_KKNotes"
