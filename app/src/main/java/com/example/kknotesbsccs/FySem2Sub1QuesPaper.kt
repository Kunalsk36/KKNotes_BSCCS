...
class FySem2Sub1QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub1_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1rjKACaKO--si8MXAqruxdeDkybmu_pVG/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1rjKACaKO--si8MXAqruxdeDkybmu_pVG"
        )
        intent.putExtra(
            "pdf_name",
            "Algorithm_2021_QP"
    ...
    fun qp2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/17YijHi-WuF1T_7vn-rK1MTKbx5PaJfFu/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=17YijHi-WuF1T_7vn-rK1MTKbx5PaJfFu"
        )
        intent.putExtra(
            "pdf_name",
            "Algorithm_2022_QP"
