...
class FySem2Sub4Notes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub4_notes)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1KfNexEmb0IG8HZNpje7uSM2LUFBi46sF/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1KfNexEmb0IG8HZNpje7uSM2LUFBi46sF"
        )
        intent.putExtra(
            "pdf_name",
            "DBMS_Question_Bank"
