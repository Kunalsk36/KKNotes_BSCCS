...
class SySem4Sub2RefBookCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub2_ref_book_cs)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1ugh4mu4OebFlz8a1hGl4eA-_Xd6nF45o/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1ugh4mu4OebFlz8a1hGl4eA-_Xd6nF45o"
        )
        intent.putExtra(
            "pdf_name",
            "Computer_Networks_Ref_Book_KK"
        )
