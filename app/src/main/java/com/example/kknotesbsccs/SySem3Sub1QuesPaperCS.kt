...
class SySem3Sub1QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub1_ques_paper_cs)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/10q_CfY60GTjqAFTTqgKIgmrLb8F5q30O/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=10q_CfY60GTjqAFTTqgKIgmrLb8F5q30O"
        )
        intent.putExtra(
            "pdf_name",
            "OS_2022_QP"
