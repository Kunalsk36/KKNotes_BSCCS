...
class FySem2Sub6QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub6_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1KNm9Wt5N_tk_tzUBg_nLC5-t7zQ1pS6b/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1KNm9Wt5N_tk_tzUBg_nLC5-t7zQ1pS6b"
        )
        intent.putExtra(
            "pdf_name",
            "Stat_2021_Question_Paper"
        )
    ...
    fun qp2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1jfvcw22Ks0EE1cMdwvedE1FKUiHFc5Zj/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1jfvcw22Ks0EE1cMdwvedE1FKUiHFc5Zj"
        )
        intent.putExtra(
            "pdf_name",
            "Stat_2022_Question_Paper"
        )
        startActivity(intent)
    }
}