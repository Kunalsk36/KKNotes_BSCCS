...
class FySem1Sub4RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub4_ref_book)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1niqaVqVzZsQc5zlKvpvd-v45Brpdxmhw/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1niqaVqVzZsQc5zlKvpvd-v45Brpdxmhw"
        )
        intent.putExtra(
            "pdf_name",
            "Free_and_Open_Source_Software_tech_max"
        )
