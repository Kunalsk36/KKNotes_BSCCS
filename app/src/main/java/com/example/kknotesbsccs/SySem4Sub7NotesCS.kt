...
class SySem4Sub7NotesCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub7_notes_cs)
        ...
        CommonOnClicks(navSem1Sub1, this, SySem4Sub7CS::class.java)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1A9m8TxsLz6mEbSk0lvO4DZTN_H2doenb/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1A9m8TxsLz6mEbSk0lvO4DZTN_H2doenb"
        )
        intent.putExtra(
            "pdf_name",
            "Management_And_Entrepreneurship_Questions_Answers_KKNotes"
        )
    ...
    fun notes2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/138KEy3ewygqr63qtkl4S8vT_dGOfLkaP/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=138KEy3ewygqr63qtkl4S8vT_dGOfLkaP"
        )
        intent.putExtra(
            "pdf_name",
            "Management_And_Entrepreneurship_Question_Bank_KKNotes"
        )
        startActivity(intent)
    }
}