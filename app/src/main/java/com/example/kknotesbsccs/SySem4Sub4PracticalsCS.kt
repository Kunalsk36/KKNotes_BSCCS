...
class SySem4Sub4PracticalsCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub4_practicals_cs)
    ...
    fun prac1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1LVzWl-GwcdwqB8jLWM-4y4o2mu-HZovZ/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1LVzWl-GwcdwqB8jLWM-4y4o2mu-HZovZ"
        )
        intent.putExtra(
            "pdf_name",
            "IoT_Practicals_KKNotes"
        )
