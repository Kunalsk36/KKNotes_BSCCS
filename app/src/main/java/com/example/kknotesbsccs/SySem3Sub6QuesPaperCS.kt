...
class SySem3Sub6QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub6_ques_paper_cs)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1PyCzaiU-tgjHnPWzQIxpjknURlvzYIlB/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1PyCzaiU-tgjHnPWzQIxpjknURlvzYIlB"
        )
        intent.putExtra(
            "pdf_name",
            "Web_Technologies_2022_QP_KK"
        )
