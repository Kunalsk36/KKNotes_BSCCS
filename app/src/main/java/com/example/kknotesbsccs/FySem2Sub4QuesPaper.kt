...
class FySem2Sub4QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub4_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1RwOj5zt3C25xoLc_ICMlwitF2ut1kMpz/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1RwOj5zt3C25xoLc_ICMlwitF2ut1kMpz"
        )
        intent.putExtra(
            "pdf_name",
            "Database_System_2021_Question_Paper"
        )
    ...
    fun qp2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/12dSoDxorkpB6cQzmg1A4mvf3W5NMGaUe/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=12dSoDxorkpB6cQzmg1A4mvf3W5NMGaUe"
        )
        intent.putExtra(
            "pdf_name",
            "Database_System_2022_Question_Paper"
        )
        startActivity(intent)
    }
}