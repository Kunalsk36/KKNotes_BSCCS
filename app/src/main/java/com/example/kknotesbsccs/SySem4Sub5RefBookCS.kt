...
class SySem4Sub5RefBookCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub5_ref_book_cs)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1MsPWIvD5gpPSpy5EN04eGe4K_QXFiZLE/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1MsPWIvD5gpPSpy5EN04eGe4K_QXFiZLE"
        )
        intent.putExtra(
            "pdf_name",
            "Android_Application_Development_with_Kotlin_Ref_Book_KK"
        )
