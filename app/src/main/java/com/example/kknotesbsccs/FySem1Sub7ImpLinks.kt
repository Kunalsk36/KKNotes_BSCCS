...
class FySem1Sub7ImpLinks : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub7_imp_links)
    ...
    fun impLink1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://engineeringinterviewquestions.com/communication-skills-mcqs-and-answers/"
        )
