...
class SySem4Sub4QuesPaperCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub4_ques_paper_cs)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1bOJAzS4GMpvKo2dEMtarj3Zg6_rydDeJ/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1bOJAzS4GMpvKo2dEMtarj3Zg6_rydDeJ"
        )
        intent.putExtra(
            "pdf_name",
            "IoT_2023_QP_KKNotes"
