...
class FySem1Sub1Notes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub1_notes)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1jHFMO9DBuH9SoVcB10Tqf22yf90byB9z/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1jHFMO9DBuH9SoVcB10Tqf22yf90byB9z"
        )
        intent.putExtra(
            "pdf_name",
            "DSA_Notes"
