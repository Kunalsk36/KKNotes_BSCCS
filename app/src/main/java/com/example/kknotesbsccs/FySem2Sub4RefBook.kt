...
class FySem2Sub4RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub4_ref_book)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1Kp30YRXuM3L_kjTaUBXJkABHMteGsxGi/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1Kp30YRXuM3L_kjTaUBXJkABHMteGsxGi"
        )
        intent.putExtra(
            "pdf_name",
            "Fundamentals_of_Database_System"
        )
