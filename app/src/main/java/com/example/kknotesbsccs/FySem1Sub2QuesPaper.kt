...
class FySem1Sub2QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub2_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/16B1cnGklRDBTZIRlTKMDwUjByY7Z7VPy/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=16B1cnGklRDBTZIRlTKMDwUjByY7Z7VPy"
        )
        intent.putExtra(
            "pdf_name",
            "Python_2022_QP"
