...
class FySem1Sub2Notes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub2_notes)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1BBGwPkcbA4ax7BvwGreD4Geb0ozDqfzp/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1BBGwPkcbA4ax7BvwGreD4Geb0ozDqfzp"
        )
        intent.putExtra(
            "pdf_name",
            "Function_Programs"
    ...
    fun notes2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1hJ_gaF1XdE_KOGwsxGHqL-CfJY9PinuL/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1hJ_gaF1XdE_KOGwsxGHqL-CfJY9PinuL"
        )
        intent.putExtra(
            "pdf_name",
            "Python Dictionary"
    ...
    fun notes3Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1XWJY78BNqzjeZcqygdoGxm2ckMkNHVtu/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1XWJY78BNqzjeZcqygdoGxm2ckMkNHVtu"
        )
        intent.putExtra(
            "pdf_name",
    ...
    fun notes4Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/10kbkF5ZTz5eVqD9AXD-SPKuFgT9DUEiv/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=10kbkF5ZTz5eVqD9AXD-SPKuFgT9DUEiv"
        )
        intent.putExtra(
            "pdf_name",
            "Python_Lambda_Functions"
