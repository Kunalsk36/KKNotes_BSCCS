...
class FySem2Sub2QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub2_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1WmvNpzvSK-wSeXldDp4OaxmH1TFBIioQ/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1WmvNpzvSK-wSeXldDp4OaxmH1TFBIioQ"
        )
        intent.putExtra(
            "pdf_name",
            "Adv_Python_2021_QP"
    ...
    fun qp2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1qqKEfYG3aJrGxRgm9LX9TGANXPgsVnWS/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1qqKEfYG3aJrGxRgm9LX9TGANXPgsVnWS"
        )
        intent.putExtra(
            "pdf_name",
            "Adv_Python_2022_QP"
