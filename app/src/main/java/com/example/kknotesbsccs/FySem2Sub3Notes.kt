...
class FySem2Sub3Notes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub3_notes)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1mvj93hYeMT8upir72DFMwHyGHDTBNA8O/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1mvj93hYeMT8upir72DFMwHyGHDTBNA8O"
        )
        intent.putExtra(
            "pdf_name",
            "INTRODUCTION_TO_OOPS_USING_Cpp_KKNOTES"
        )
    ...
    fun notes2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1G0f70vxQQG22nThX5nrnlOCVInZgNenM/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1G0f70vxQQG22nThX5nrnlOCVInZgNenM"
        )
        intent.putExtra(
            "pdf_name",
            "Cpp_Question_Bank"
