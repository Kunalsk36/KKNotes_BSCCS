...
class SySem4Sub7ImpLinksCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub7_imp_links_cs)
    ...
    fun impLink1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://byjus.com/commerce/difference-between-management-and-entrepreneurship/"
        )
