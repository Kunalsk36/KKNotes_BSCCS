...
class FySem1Sub6Notes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub6_notes)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/13moR2qpiROfBDziwcSRB2P2Z2dM5Hj5x/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=13moR2qpiROfBDziwcSRB2P2Z2dM5Hj5x"
        )
        intent.putExtra(
            "pdf_name",
            "DS_Notes"
