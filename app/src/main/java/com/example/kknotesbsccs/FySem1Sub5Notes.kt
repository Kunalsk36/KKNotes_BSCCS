...
class FySem1Sub5Notes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub5_notes)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1c-V7fdmD90rb-isw4nciY1N1Hg6hqyuH/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1c-V7fdmD90rb-isw4nciY1N1Hg6hqyuH"
        )
        intent.putExtra(
            "pdf_name",
