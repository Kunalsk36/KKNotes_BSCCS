...
class FySem2Sub1ImpLinks : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub1_imp_links)
    ...
    fun impLink1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://www.codingninjas.com/codestudio/library/design-and-algorithm-analysis"
        )
