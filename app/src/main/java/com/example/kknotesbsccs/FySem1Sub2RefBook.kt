...
class FySem1Sub2RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub2_ref_book)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1-AT3eVV0jXdn3s9kWE0n9MXPT9WhkSCR/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1-AT3eVV0jXdn3s9kWE0n9MXPT9WhkSCR"
        )
        intent.putExtra(
            "pdf_name",
            "Intro_to_CS_Using_Python"
        )
    ...
    fun refbook2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1osoTJSYB2YEYZpItbBKBjo2Y8TEGeFoK/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1osoTJSYB2YEYZpItbBKBjo2Y8TEGeFoK"
        )
        intent.putExtra(
            "pdf_name",
            "Beginning_Python_From_Novice_to_Professional_Third_Ed"
        )
        startActivity(intent)
    }
}