...
class SySem3Sub7RefBookCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub7_ref_book_cs)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1xLyTe1Fdqmo8iFK-Sh004bofPJcpKSs1/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1xLyTe1Fdqmo8iFK-Sh004bofPJcpKSs1"
        )
        intent.putExtra(
            "pdf_name",
            "Writing_for_the_Web_Ref_Book_KK"
        )
