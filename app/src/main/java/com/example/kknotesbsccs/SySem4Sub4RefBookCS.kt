...
class SySem4Sub4RefBookCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub4_ref_book_cs)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1LjLYSkNCmh1x2UGh5K8zuUDiiSoXwQri/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1LjLYSkNCmh1x2UGh5K8zuUDiiSoXwQri"
        )
        intent.putExtra(
            "pdf_name",
            "Introduction_to_IoT_Ref_Book_KK"
        )
