...
class FySem1Sub4Notes : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub4_notes)
        ...
        CommonOnClicks(navSem1Sub3, this, FySem1Sub4::class.java)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1OIwZIsepkIV70Ygtp_E4oS5ac-boVLqK/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1OIwZIsepkIV70Ygtp_E4oS5ac-boVLqK"
        )
        intent.putExtra(
            "pdf_name",
            "Intro_OST"
    ...
    fun notes2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1Aca0JxKb_2bQz0VbH3l9T2OmMo8EgMw_/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1Aca0JxKb_2bQz0VbH3l9T2OmMo8EgMw_"
        )
        intent.putExtra(
            "pdf_name",
            "OST_CaseStudies"
