...
class FySem2Sub3QuesPaper : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem2_sub3_ques_paper)
    ...
    fun qp1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1rujtJlKsQQ4L-GXgxVii6e8Qglau-iq1/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1rujtJlKsQQ4L-GXgxVii6e8Qglau-iq1"
        )
        intent.putExtra(
            "pdf_name",
            "CPP_2021_QP"
    ...
    fun qp2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1-L6t-huC57tc3ax9Plnu31q3l5BwMKAT/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1-L6t-huC57tc3ax9Plnu31q3l5BwMKAT"
        )
        intent.putExtra(
            "pdf_name",
            "CPP_2022_QP"
