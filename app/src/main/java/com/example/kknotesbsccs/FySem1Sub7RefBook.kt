...
class FySem1Sub7RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub7_ref_book)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1UUPuEITOfyjE2vWgPvoZeYEEm7-NJRWm/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1UUPuEITOfyjE2vWgPvoZeYEEm7-NJRWm"
        )
        intent.putExtra(
            "pdf_name",
            "Soft_Skill_RefBook"
