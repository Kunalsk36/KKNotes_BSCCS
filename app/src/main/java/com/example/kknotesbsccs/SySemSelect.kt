...
class SySemSelect : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem_select)
    ...
    fun sem3clk(view: View) {
        intent = Intent(this, SYSem3SubSelect::class.java)
        startActivity(intent)
    }

    fun sem4clk(view: View) {
        intent = Intent(this, SYSem4SubSelect::class.java)
        startActivity(intent)
    }
}