...
class SySem4Sub7RefBookCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub7_ref_book_cs)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/13vB6upOdkqa4kA1y5oMs_xuztmygD2h-/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=13vB6upOdkqa4kA1y5oMs_xuztmygD2h-"
        )
        intent.putExtra(
            "pdf_name",
            "Management_and_Entrepreneurship_Ref_Book_KK"
        )
