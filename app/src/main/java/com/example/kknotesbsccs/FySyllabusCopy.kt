...
class FySyllabusCopy : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_syllabus_copy)
    ...
    fun syllabusClick(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/130WxLXRYeKQoHwbXE-bgPTF8mj8vb_5t/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=130WxLXRYeKQoHwbXE-bgPTF8mj8vb_5t"
        )
        intent.putExtra(
            "pdf_name",
            "FYBSC CS Syllabus 2021-22"
        )
