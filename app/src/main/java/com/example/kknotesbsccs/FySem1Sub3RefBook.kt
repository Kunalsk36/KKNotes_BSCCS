...
class FySem1Sub3RefBook : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_fy_sem1_sub3_ref_book)
    ...
    fun refbook1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1Be_h3G15ZcDw2XLPM5TM9GQgci_Xrb0o/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1Be_h3G15ZcDw2XLPM5TM9GQgci_Xrb0o"
        )
        intent.putExtra(
            "pdf_name",
