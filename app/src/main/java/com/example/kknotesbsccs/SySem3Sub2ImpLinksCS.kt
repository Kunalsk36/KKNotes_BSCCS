...
class SySem3Sub2ImpLinksCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem3_sub2_imp_links_cs)
    ...
    fun impLink2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://www.sanfoundry.com/linear-algebra-multiple-choice-questions-answers/"
        )
        startActivity(intent)
    }
}