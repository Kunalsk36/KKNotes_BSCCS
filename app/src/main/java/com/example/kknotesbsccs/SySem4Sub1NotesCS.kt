...
class SySem4Sub1NotesCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_sem4_sub1_notes_cs)
        ...
        CommonOnClicks(navSem1Sub1, this, SySem4Sub1CS::class.java)
    ...
    fun notes1Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1dn-iF2M45Y0jBmAHy5Ucq6lOWnVo01XW/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1dn-iF2M45Y0jBmAHy5Ucq6lOWnVo01XW"
        )
        intent.putExtra(
            "pdf_name",
            "TOC_Notes_KK"
    ...
    fun notes2Click(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1c5EIyzEqd49_YEIohKmpxLoawktC1UeG/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1c5EIyzEqd49_YEIohKmpxLoawktC1UeG"
        )
        intent.putExtra(
            "pdf_name",
            "ToC_Tutorial_Notes_KK"
        )
        startActivity(intent)
    }
}