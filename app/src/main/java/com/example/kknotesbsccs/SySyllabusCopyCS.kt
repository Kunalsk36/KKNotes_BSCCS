...
class SySyllabusCopyCS : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sy_syllabus_copy_cs)
        ...
        CommonOnClicks(navSem1Sub1, this, SySem3Sub1CS::class.java)
    ...
    fun syllabusClick(view: View) {
        ...
        intent.putExtra(
            "pdf_url",
            "https://drive.google.com/file/d/1aNYd-VOKA6Jv8hkiSUhGEigeznXh22Os/view?usp=sharing"
        )
        intent.putExtra(
            "download_link",
            "https://drive.google.com/uc?export=download&id=1aNYd-VOKA6Jv8hkiSUhGEigeznXh22Os"
        )
        intent.putExtra(
            "pdf_name",
            "SYBSC_CS_Syllabus=_2022_23"
        )
